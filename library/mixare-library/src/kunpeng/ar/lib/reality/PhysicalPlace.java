 ...
 */
package kunpeng.ar.lib.reality;
...
public class PhysicalPlace implements Parcelable {
	...
	public static void convLocToVec(Location org, PhysicalPlace gp, ARVector v) {
		float[] z = new float[1];
		z[0] = 0;
	...
	public static void convertVecToLoc(ARVector v, Location org, Location gp) {
