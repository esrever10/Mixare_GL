 ...
 */
package kunpeng.ar.mgr.webcontent;
...
class WebPageMgrImpl implements WebContentManager {
	...
	/* (non-Javadoc)
	 * @see kunpeng.ar.mgr.webcontent.WebContentManager#loadWebPage(java.lang.String, android.content.Context)
	 */
	public void loadWebPage(String url, Context context) throws Exception {
		...
		d.getWindow().setGravity(Gravity.LEFT | Gravity.RIGHT);
		if(context == mixContext.getActualMixView()) 
		{
...
//		}
	...
	/* (non-Javadoc)
	 * @see kunpeng.ar.mgr.webcontent.WebContentManager#processUrl(java.lang.String, android.content.Context)
	 */
