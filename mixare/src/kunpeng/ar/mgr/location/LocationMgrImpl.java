 ...
 */
package kunpeng.ar.mgr.location;
...
class LocationMgrImpl implements LocationFinder {
	 ...
	 * 
	 * @see
	 * kunpeng.ar.mgr.location.LocationFinder#findLocation(android.content.Context
	 * )
	 */
	public void findLocation() {
		...
		// Huangpu Road, HighTech Zone, Dalian, China
		hardFix.setLatitude(38.8616838);
		hardFix.setLongitude(121.5255765);
		...
		try {
			...
			if (curLoc == null && lm.isProviderEnabled(lm.GPS_PROVIDER)) {
				curLoc = lm.getLastKnownLocation(lm.GPS_PROVIDER);
			}
			if (curLoc == null && lm.isProviderEnabled(lm.NETWORK_PROVIDER)) {
				curLoc = lm.getLastKnownLocation(lm.NETWORK_PROVIDER);
			}
			if(curLoc == null) {
				curLoc = hardFix;
			}
			...
			// ex2.printStackTrace();
			curLoc = hardFix;
			mixContext.doMsgPopUp(R.string.connection_GPS_dialog_text);
		}
	}
	 ...
	 * 
	 * @see
	 * kunpeng.ar.mgr.location.LocationFinder#locationCallback(android.content
	 * .Context)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see kunpeng.ar.mgr.location.LocationFinder#getCurrentLocation()
	 */
	public Location getCurrentLocation() {
		if (curLoc == null) {
			mixContext.doMsgPopUp(R.string.location_not_found);
	 ...
	 * (non-Javadoc)
	 * 
	 * @see kunpeng.ar.mgr.location.LocationFinder#getLocationAtLastDownload()
	 */
	 ...
	 * 
	 * @see
	 * kunpeng.ar.mgr.location.LocationFinder#setLocationAtLastDownload(android
	 * .location.Location)
	 */
	 ...
	 * 
	 * @see
	 * kunpeng.ar.mgr.location.LocationFinder#setDownloadManager(kunpeng.ar.
	 ...
	 * (non-Javadoc)
	 * 
	 * @see kunpeng.ar.mgr.location.LocationFinder#getGeomagneticField()
	 */
