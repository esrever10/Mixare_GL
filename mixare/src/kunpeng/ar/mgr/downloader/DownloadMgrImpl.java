 ...
 */
package kunpeng.ar.mgr.downloader;
...
import kunpeng.ar.mgr.HttpTools;
...
class DownloadMgrImpl implements Runnable, DownloadManager {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see kunpeng.ar.mgr.downloader.DownloadManager#run()
	 */
	public void run() {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see kunpeng.ar.mgr.downloader.DownloadManager#purgeLists()
	 */
	 ...
	 * 
	 * @see
	 * kunpeng.ar.mgr.downloader.DownloadManager#submitJob(kunpeng.ar.mgr.downloader
	 * .DownloadRequest)
	 */
...
//				Log.i(ARView.TAG, "Submitted " + job.toString());
	 ...
	 * 
	 * @see
	 * kunpeng.ar.mgr.downloader.DownloadManager#getReqResult(java.lang.String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see kunpeng.ar.mgr.downloader.DownloadManager#getNextResult()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see kunpeng.ar.mgr.downloader.DownloadManager#getResultSize()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see kunpeng.ar.mgr.downloader.DownloadManager#isDone()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see kunpeng.ar.mgr.downloader.DownloadManager#goOnline()
	 */
